...
export interface LepakCoreDummyInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: 'joinWithEth', values: [PromiseOrValue<string>]): string
...
export interface LepakCoreDummy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: LepakCoreDummyInterface
  ...
  callStatic: {
    ...
    joinWithEth(infoURI: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>
