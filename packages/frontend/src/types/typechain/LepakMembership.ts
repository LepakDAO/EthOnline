...
export interface LepakMembershipInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: 'thresholds', values: [PromiseOrValue<BigNumberish>]): string
  encodeFunctionData(
...
export interface LepakMembership extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: LepakMembershipInterface
  ...
  functions: {
    ...
    thresholds(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>
